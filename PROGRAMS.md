...
```
### 6 Program to Average of n Numbers
```C
#include <stdio.h>
int main()
{
...
```
### 7 Program to Table_using_for loop
```C
#include <stdio.h>
int main()
{
...
```
### 13 Program to Two Greater Numbers
```C
#include<stdio.h>
void main()
{       
...
```
### 14 Program to sum of first 100 numbers
```C
 #include <stdio.h>
int main()
{
 ...
 ```
### 15 Program to gcd of numbers.c
```C
#include<stdio.h>
int main()
{
...
```
### 17 Program to Three Greater number
```C
#include<stdio.h>
void main()
{
...
```
### 18 Program to Palindrome No.or Not
```C
...
```
### 20 Program to Employess Datails.
```C
#include <stdio.h>
...
```
### 24 Program to Call_ By _value.C
```C
#include <stdio.h>
...
```
### 25  Program to Arthmatic Operatar
```C
#include<stdio.h>
int main()
{
